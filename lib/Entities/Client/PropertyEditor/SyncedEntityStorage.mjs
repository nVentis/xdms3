...
class SyncedEntityStorage extends EntityStorage {
	...
	Sync (
		 ...
		 *
		 * @param {Function<SyncedPropertyTypeObjectInterface>} propType
		 * @param diffTree
		 * @param sourceTree
		 * @returns {SyncAction[]}
		 */
		 ...
		 * @param diffTree
		 * @return {{alteredSubCollections: [], alteredOwnProperties: [], alteredSubEntities: []}}
		 */
...
class SyncAction {
	/**
	 *
	 * @param {typeof SyncedPropertyTypeObjectInterface} propertyType
